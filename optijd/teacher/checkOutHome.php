...
if(isset($_POST['mail']))
{
    foreach($_SESSION['students'] as $studentId)
    {
        ...
        $messageMail .= "" . $fullName . " heeft zich om " . $time . " afgemeld, en is naar huis vertrokken.\n\n";
...
{
    header('location: goHome.php?group_id='.$groupId.'');
}
?>
            ...
            <div id="content">
                ...
                <div class="presence clearFix">
                    ...
                    if(!empty($_SESSION['students']))
                    {
                        ...
                        echo "<br />" . "<p>De bovenstaande leerlingen gaan naar huis.</p> <br />
                    ...
                    {
                        echo "Er is niemand afgemeld. Klik op terug om alsnog leerlingen af te melden. <br />
                             <a href='index.php'>Klik hier om terug te keren naar het startscherm.</a>";
                    }
                    ?>
