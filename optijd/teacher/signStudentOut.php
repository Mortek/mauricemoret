    ...
    <body>
        <div id="wrapper">
            <div id="content">
                ...
                <h1 class="floatLeft centerH1"><a href="index.php">Leerling afmelden</a></h1>
                ...
                <div class="group clearFix">
                    ...
                    ?>
                        <tr>
                            <td><a href="reportStudent.php?student_id=<?php echo $student->getId(); ?>"><?php echo " " . $student->getFirstName() . " " . $student->getInsertion() . " " . $student->getLastName(); ?></a></td>
                            <td><?php echo $student->getGroupIdentifier(); ?></td>
                        </tr>
                    <?php
                    }
                    ?>
