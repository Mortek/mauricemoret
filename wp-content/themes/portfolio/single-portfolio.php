...
<article>
    <header id="page-heading">
        ...
        <nav id="single-nav" class="clearfix"> 
            <?php next_post_link('<div id="single-nav-left">%link</div>', '<span class="awesome-icon-chevron-left"></span> '.__('Nieuwer','adapt').'', false); ?>
            <?php previous_post_link('<div id="single-nav-right">%link</div>', ''.__('Ouder','adapt').' <span class="awesome-icon-chevron-right"></span>', false); ?>
        </nav>
        <!-- /single-nav --> 
    </header>
    <!-- /page-heading -->
